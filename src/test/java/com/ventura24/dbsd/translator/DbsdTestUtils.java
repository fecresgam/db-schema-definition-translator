...
public class DbsdTestUtils
{
    ...
    static final String COL33_NAME = "es_jefe";
    static final String COL33_DESC = "Define si tiene alguien a su cargo";
    static final String COL34_NAME = "fecha_inicio_ss";
    static final String COL34_DESC = "La fecha en la que se le dio de alta en la SS";
    static final String COL35_NAME = "fecha_fin_ss";
    static final String COL35_DESC = "La fecha en la que se le dio de baja en la SS";
    static final String COL36_NAME = "hora_entrada";
    static final String COL36_DESC = "La hora en la que inicia la jornada laboral";
    static final String COL37_NAME = "hora_salida";
    static final String COL37_DESC = "La hora en la que finaliza la jornada laboral";
    static final String COL38_NAME = "ultima_modificacion";
    static final String COL38_DESC = "Fecha y hora de la ultima modificacion de este registro";
    ...
    public Table getTable3()
    {
        ...
        final CommonColumn col33 = new CommonColumn(COL33_NAME, DataType.BOOLEAN, getNotNullOptionAsList(),  COL33_DESC);
        final CommonColumn col34 = new CommonColumn(COL34_NAME, DataType.DATE, getNotNullOptionAsList(), COL34_DESC);
        final CommonColumn col35 = new CommonColumn(COL35_NAME, DataType.DATE, getNullOptionAsList(), COL35_DESC);
        final CommonColumn col36 = new CommonColumn(COL36_NAME, DataType.TIME, getNotNullOptionAsList(), COL36_DESC);
        final CommonColumn col37 = new CommonColumn(COL37_NAME, DataType.TIME, getNotNullOptionAsList(), COL37_DESC);
        final CommonColumn col38 = new CommonColumn(COL38_NAME, DataType.DATE_AND_TIME, column38Options, COL38_DESC);
        columns.add(col31);
        columns.add(col32);
        columns.add(col33);
        columns.add(col34);
