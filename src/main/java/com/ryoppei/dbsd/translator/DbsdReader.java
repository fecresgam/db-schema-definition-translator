...
public class DbsdReader
{
    ...
    private DataBaseSchema retrieveDataBaseSchema(final CharStream inputStream) throws RecognitionException
    {
        final TokenStream tokens =
                new CommonTokenStream(new com.ryoppei.dbsd.translator.DbsdLexer(inputStream));

        //parser generates abstract syntax tree
        final com.ryoppei.dbsd.translator.DbsdParser parser =
                new com.ryoppei.dbsd.translator.DbsdParser(tokens);
